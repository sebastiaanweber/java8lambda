...
public class StudentDataBase {
    ...
    public static Supplier<Student> studentSupplier = () -> {
        ...
        bike.setName("BMX");
        bike.setModel("606");
        Student student = new Student("Bas", 2, 3.6, "male", Arrays.asList("swimming", "basketball", "volleyball"), 10);
    ...
    public static List<Student> getAllStudents() {
         ...
         * 4th grade students
         */
        Student student5 = new Student("Sophia", 4, 3.5, "female", Arrays.asList("swimming", "dancing", "football"), 16);
